...
begin
 ...
 -- Keep opportunity examples separate from calendar fixtures, whose future bookings
 -- intentionally disqualify customers from rebooking suggestions.
 for ordinal in 1..8 loop
  ...
  for j in 1..4 loop
   aid:=('89000000-0000-4000-8000-'||lpad((ordinal*10+j)::text,12,'0'))::uuid;
